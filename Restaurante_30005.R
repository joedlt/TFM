...
png("Restaurante Cod Postal 30005.png",width = 1024, height = 880)
...
##Normalizacion de variables RFM##
...
png("Restaurante Cod Postal 30005 metodo del codo.png",bg="white")
...
dev.off()
png("Restaurante Cod Postal 30005 NbClust.png ")
...
dev.off()
png(paste("Restaurante Cod Postal 30005 Clustering Kmeans para ",N_Cluster," CLUSTERS del Modelo RFM 12M.png",sep=""),width = 1024, height = 880)
par(mfrow=c(2, 2),oma = c(1, 0, 3, 0))
...
Des_seg<-c("PERDIDOS","RECIENTES","CLIENTE ANTIGUO","CLIENTE FRECUENCIA MEDIA","POSIBLE ABANDONO","MAYOR COMPRA MEDIA")
...
write.table(RFM_comercio,"~/Master Data Science/TFM/Segmentacion/Ficheros/Segmentos_Restaurante_30005.txt",quote = TRUE,sep = ";",col.names = FALSE, row.names = FALSE) 
