...
png("Ropa Cod Postal 07002.png",width = 1024, height = 880)
...
png("Ropa Cod Postal 07002 metodo del codo.png",bg="white")
...
dev.off()
png("Ropa Cod Postal 07002 NbClust.png ")
...
png(paste("Ropa Cod Postal 07002 Clustering Kmeans para ",N_Cluster," CLUSTERS del Modelo RFM 12M.png",sep=""),width = 1024, height = 880)
par(mfrow=c(2, 2),oma = c(1, 0, 3, 0))
...
write.table(RFM_comercio,"~/Master Data Science/TFM/Segmentacion/Ficheros/Segmentos_Ropa_07002.txt",quote = TRUE,sep = ";",col.names = FALSE, row.names = FALSE) 
